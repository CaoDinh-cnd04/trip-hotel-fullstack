...
import { LogOut, LayoutDashboard, Users as UsersIcon, FileCheck, MessageSquare, Bell, Percent, Tag, User } from 'lucide-react'
...
import HotelRegistrationManagement from './HotelRegistrationManagement'
...
import PromotionOffersManagement from './PromotionOffersManagement'

const sections = [
  { id: 'overview', label: 'Dashboard', icon: LayoutDashboard },
  { id: 'users', label: 'Người dùng', icon: UsersIcon },
  { id: 'hotel-registrations', label: 'Duyệt Hồ sơ', icon: FileCheck },
  { id: 'promotion-offers', label: 'Quản lý ưu đãi', icon: Percent },
  { id: 'feedback', label: 'Phản hồi', icon: MessageSquare },
  { id: 'create-notification', label: 'Tạo thông báo', icon: Bell },
  { id: 'create-discount-code', label: 'Tạo mã giảm giá', icon: Tag },
  ...
  const renderContent = () => {
    try {
      switch (activeSection) {
        ...
        case 'users':
          return <Users />
        case 'hotel-registrations':
          return <HotelRegistrationManagement />
        case 'promotion-offers':
          return <PromotionOffersManagement />
        case 'feedback':
